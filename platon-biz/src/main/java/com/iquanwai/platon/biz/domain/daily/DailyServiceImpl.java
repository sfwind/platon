    ...
    private String drawTalk(Profile profile, DailyTalk dailyTalk) {
        if (dailyTalk != null) {
            ...
            try {
                ...
                inputImage = ImageUtils.writeText(inputImage,70,292,"12",font.deriveFont(45f),Color.BLACK);
                inputImage = ImageUtils.writeText(inputImage,130,292,"天",font.deriveFont(22f),grey);
                inputImage = ImageUtils.writeText(inputImage,280,292,"365",font.deriveFont(45f),Color.BLACK);
                inputImage = ImageUtils.writeText(inputImage,360,292,"个",font.deriveFont(22f),grey);
                inputImage = ImageUtils.writeText(inputImage,542,292,"12%",font.deriveFont(45f),Color.BLACK);
