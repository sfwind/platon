    ...
    private String drawTalk(Profile profile, DailyTalk dailyTalk) {
        if (dailyTalk != null) {
            ...
            try {
                ...
                inputImage = ImageUtils.writeText(inputImage,130,262,"天",font.deriveFont(22f),grey);
                inputImage = ImageUtils.writeText(inputImage,280,262,"365",font.deriveFont(45f),Color.BLACK);
                inputImage = ImageUtils.writeText(inputImage,360,262,"个",font.deriveFont(22f),grey);
                inputImage = ImageUtils.writeText(inputImage,542,262,"12%",font.deriveFont(45f),Color.BLACK);
                inputImage = ImageUtils.writeText(inputImage,622,262,"的同学",font.deriveFont(22f),grey);
