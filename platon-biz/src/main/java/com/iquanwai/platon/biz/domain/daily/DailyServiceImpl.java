    ...
    private String drawTalk(Profile profile, DailyTalk dailyTalk) {
        if (dailyTalk != null) {
            ...
            try {
                ...
                inputImage = ImageUtils.writeText(inputImage, 128, 32, nickName, font.deriveFont(42f), Color.BLACK);
                inputImage = ImageUtils.writeText(inputImage,128,80,"又在圈外商学院学习一天",font.deriveFont(42f),Color.red);
