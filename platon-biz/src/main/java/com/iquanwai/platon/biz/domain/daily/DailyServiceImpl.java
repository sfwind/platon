    ...
    private String drawTalk(Profile profile, DailyTalk dailyTalk) {
        if (dailyTalk != null) {
            ...
            try {
                ...
                inputImage = ImageUtils.writeText(inputImage,70,262,"12",font.deriveFont(60f),Color.BLACK);
                inputImage = ImageUtils.writeText(inputImage,90,262,"天",font.deriveFont(22f),grey);
                inputImage = ImageUtils.writeText(inputImage,280,262,"365",font.deriveFont(60f),Color.BLACK);
                inputImage = ImageUtils.writeText(inputImage,200,262,"个",font.deriveFont(22f),grey);
                inputImage = ImageUtils.writeText(inputImage,542,262,"12%",font.deriveFont(60f),Color.BLACK);
