...
public class DailyServiceImpl implements DailyService {
    ...
    private static final String DAILY_TALK_BACKEND = ConfigUtils.getPicturePrefix()+"images/dailytalk/source/final_backend_online.jpg";
    ...
    public void sendMsg(String openid) {
        ...
        String templateMsg = "小小的感动，每日的点滴，你的进步就在圈外～赶快加入我们一起学习吧～\n\n<a href='"+ConfigUtils.domainName()+"/rise/static/home'>点击了解更多</a>";
