...
public class PracticeController {
    ...
    public ResponseEntity<Map<String, Object>> startWarmup(LoginUser loginUser,
        ...
        try{
            ...
            LOGGER.error("获取热身训练失败, "+loginUser.getWeixinName(), e);
            return WebUtils.error("获取热身训练失败");
        }
    }
    ...
    public ResponseEntity<Map<String, Object>> answer(LoginUser loginUser,
        ...
        try{
            ...
            LOGGER.error("提交热身训练失败, "+loginUser.getWeixinName(), e);
            return WebUtils.error("提交热身训练失败");
        }
    }
    ...
    public ResponseEntity<Map<String, Object>> startApplication(LoginUser loginUser,
        ...
        try{
            ...
            LOGGER.error("获取应用训练失败, "+loginUser.getWeixinName(), e);
            return WebUtils.error("获取应用训练失败");
        }
    }
    ...
    public ResponseEntity<Map<String, Object>> startChallengeApplication(LoginUser loginUser,
        ...
        try{
            ...
            LOGGER.error("获取挑战训练失败, "+loginUser.getWeixinName(), e);
            return WebUtils.error("获取挑战训练失败");
        }
    }
