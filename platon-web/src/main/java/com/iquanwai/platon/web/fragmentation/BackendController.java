...
public class BackendController {
    ...
    public ResponseEntity<Map<String,Object>> insertPlan(@RequestBody UserInsertPlanDto userInsertPlanDto){

        OperationLog operationLog = OperationLog.create().module("后台功能").function("增加章节").action("增加章节");
